...
## Inputs
- The job description (URL, file, or pasted text — already fetched by the scanner; you don't fetch).
...
3. Score 0–100 and assign a band (Strong / Good / Stretch / Skip) per `_shared.md`.
