...
2. Si pega o comparte un currículum (texto, o un PDF/DOCX que puedas leer), extrae su nombre, área
   ...
   inventes datos.
3. Confirma lo esencial, con los valores por defecto de Jobdar: **región** (Medio Oeste),
   **nivel(es)** (inicial; intermedio opcional; senior opcional) y **perfil de ajuste**
   (new_grad / no_degree / …).
4. Escribe la configuración: ejecuta `jobdar init` con sus respuestas como flags, p. ej.
...
5. Ejecuta `jobdar scan` y pasa los mejores puestos al modo **eval**.
