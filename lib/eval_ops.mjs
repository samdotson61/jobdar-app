// Jobdar — eval operations: calibration (8a.5) + batch economics (8a.7). Kept pure where possible so
// the trust math and the batch wire-shaping are unit-tested offline; the live scorer is the opt-in
// `jobdar calibrate` command, never `npm test` (preserves the offline-test invariant).
