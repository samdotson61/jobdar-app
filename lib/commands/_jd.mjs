// Jobdar — shared JD resolution for tailor/outreach with dead-link honesty. Job boards expire
// postings fast, so a fetch failure is an EXPECTED condition: print one clean bilingual line and
// report ok:false — never let it escape as a stack trace (bin/jobdar's global handler stack-dumps
