...
<meta name="viewport" content="width=device-width, initial-scale=1"><title>Jobdar</title>
<style>
  ...
  <div class="card"><h2>${esc(t('dashboard.portals'))}</h2>
    <div>${esc(t('scan.portals_count', { count: portals.length }))}</div>
  </div>
  <footer>${esc(t('dashboard.footer'))}</footer>
</div></body></html>`
}
