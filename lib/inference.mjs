...
export async function callMessages(active, { system, user, maxTokens = 1024, timeoutMs = 120000 }) {
...
export async function callOpenAI(active, { system, user, maxTokens = 1024, timeoutMs = 120000 }) {
