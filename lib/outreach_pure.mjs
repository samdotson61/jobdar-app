// Jobdar — the PURE outreach logic (Phase 10 split): cadence rules, people-finder links,
...
// Exported to the native/web apps via @jobdar/engine so on-device outreach runs the identical rules.
