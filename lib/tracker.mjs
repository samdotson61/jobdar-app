// Jobfaro — application tracker. The tracker is a VIEW over the pipeline store (data/pipeline.tsv), not
// a second file: a role enters the tracker the moment its status moves past discovery/eval — via the
// TUI's `a` key or `jobfaro tracker --set <url> <state>`. States are the canonical IDs in
