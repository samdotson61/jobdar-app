// Jobdar — intelligent company/portal discovery (Phase 9.4). The scanner runs over a seed of known ATS
...
// Jobdar then deterministically probes their Greenhouse/Lever/Ashby slugs and keeps ONLY boards that
