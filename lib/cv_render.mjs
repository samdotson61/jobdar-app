// Jobfaro — résumé rendering (career-ops "Customize" stage). Turns a markdown cv.md into a clean,
// ATS-friendly HTML résumé (single column, standard fonts, semantic headings, selectable text — no
// tables, images, or columns that confuse ATS parsers). Pure + zero-dep; `jobfaro pdf` renders this
