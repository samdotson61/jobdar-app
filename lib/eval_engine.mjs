...
export const TRANSFERABLE_EVAL_NOTE =
  '\n\nTRANSFERABLE-SKILLS MODE (the candidate is a new grad / career changer): when rating skills and ' +
  'experience, CREDIT transferable and adjacent skills that genuinely map to the role — cite the résumé ' +
  'item and the requirement it bridges. Do NOT inflate: a transferable (not direct) skill is at most ' +
  '"partial" unless the bridge is strong and clearly evidenced. Strongly targeted fits only — quality over quantity.'
