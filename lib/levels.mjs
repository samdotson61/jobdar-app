...
// Level keyword signals, checked senior -> mid -> entry (highest wins, so "Senior Analyst II"
// reads senior). Coarse by design — the model does the nuanced read on the JD.
const SENIOR = /\b(senior|sr\.?|staff|lead|principal|director|vp|chief|head)\b/
