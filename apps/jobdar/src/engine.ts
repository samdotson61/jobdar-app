...
const STR: Record<Lang, Dict> = {
  en: {
    ...
    'search.backendDown': 'Can’t reach the local backend. Start it in a terminal — `jobdar serve` — then retry.',
    'common.retry': 'Retry',
  ...
  es: {
    ...
    'search.backendDown': 'No se puede conectar con el backend local. Inícialo en una terminal — `jobdar serve` — y reintenta.',
