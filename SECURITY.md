...
- **No secrets in code or logs.** Jobdar ships no API keys. If you configure an inference API key
  (Phase 8), only the minimal JD + CV excerpt is sent to the provider you chose, with zero-retention
