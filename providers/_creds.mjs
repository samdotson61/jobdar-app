// Jobfaro — provider-credential seam (Phase 10). Providers must stay PURE (fetch-only, no fs/config)
...
// (bin/jobfaro + scan.mjs); the apps wire their own settings store — or leave the default (no creds),
